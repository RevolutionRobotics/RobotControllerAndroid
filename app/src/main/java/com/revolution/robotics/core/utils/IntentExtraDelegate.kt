...
sealed class IntentExtraDelegate<T>(protected val key: kotlin.String, protected val defaultValue: T) :
    ...
    class Boolean(key: kotlin.String, defaultValue: kotlin.Boolean = false) :
        IntentExtraDelegate<kotlin.Boolean>(key, defaultValue) {

        override fun getValue(thisRef: Intent?, property: KProperty<*>) =
            thisRef?.getBooleanExtra(key, defaultValue) ?: defaultValue
    ...
    class Int(key: kotlin.String, defaultValue: kotlin.Int = 0) : IntentExtraDelegate<kotlin.Int>(key, defaultValue) {
        ...
        override fun getValue(thisRef: Intent?, property: KProperty<*>) =
            thisRef?.getIntExtra(key, defaultValue) ?: defaultValue
    ...
    class String(key: kotlin.String, defaultValue: kotlin.String = "") :
        IntentExtraDelegate<kotlin.String>(key, defaultValue) {
