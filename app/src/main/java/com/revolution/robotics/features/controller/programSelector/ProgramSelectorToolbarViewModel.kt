...
class ProgramSelectorToolbarViewModel(resourceResolver: ResourceResolver) : ToolbarViewModel() {
    ...
    init {
        title.set(resourceResolver.string(R.string.program_selector_title))
    }
}
